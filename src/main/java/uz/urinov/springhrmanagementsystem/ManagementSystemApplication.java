package uz.urinov.springhrmanagementsystem;
...
import uz.urinov.springhrmanagementsystem.entity.*;
...
import uz.urinov.springhrmanagementsystem.repository.*;
...
import static uz.urinov.springhrmanagementsystem.entity.enums.TaskStatus.*;
...
public class ManagementSystemApplication implements CommandLineRunner {
    ...
    @Autowired
    public ManagementSystemApplication(RoleRepository roleRepository, TaskStatusRepository statusRepository, MonthRepository monthRepository, UserRepository userRepository, PasswordEncoder passwordEncoder, InOutStatusRepository inOutStatusRepository) {
    ...
    public void run(String... args) {
        if (Objects.equals(initializer, "always")) {
            ...
            inOutStatusRepository.saveAll(Arrays.asList(
                    new InOutStatus(null, uz.urinov.springhrmanagementsystem.entity.enums.InOutStatus.INPUT_STATUS),
                    new InOutStatus(null, uz.urinov.springhrmanagementsystem.entity.enums.InOutStatus.OUTPUT_STATUS)
            ));
    ...
    public static void main(String[] args) {
        SpringApplication.run(ManagementSystemApplication.class);
    }
}
